...
public class TicketModelFactory {
    ...
    /**
     * Creates a Lottery Line and set the correct parent-child relationships.
     *
     * @param ticket the parent ticket
     */
    public LotteryLine createLine(Ticket ticket) {
	...
	public int calculateOutcome(LotteryLine line) {
        Assert.notNull(line);
